...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="py-16 md:py-32 bg-gold relative overflow-hidden text-navy-900 text-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10">
          ...
          <p className="text-base sm:text-lg md:text-xl font-medium mb-8 sm:mb-10 max-w-2xl mx-auto opacity-80 px-2">
            {language === 'fa' 
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full sm:w-auto px-4 sm:px-0">
            <a href="https://wa.me/93700551228" className="px-6 sm:px-8 py-3.5 sm:py-4 rounded-full bg-navy-900 text-white font-bold hover:scale-105 transition-transform shadow-xl w-full sm:w-auto text-sm sm:text-base">
              {language === 'fa' ? "واتساپ (افغانستان)" : "WhatsApp (AF)"}
            </a>
            <a href="https://wa.me/923290335528" className="px-6 sm:px-8 py-3.5 sm:py-4 rounded-full bg-white text-navy-900 font-bold border-2 border-navy-900 hover:scale-105 transition-transform shadow-xl w-full sm:w-auto text-sm sm:text-base">
