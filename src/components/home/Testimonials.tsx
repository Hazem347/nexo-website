    ...
    <section className="py-16 md:py-24 bg-navy-800 relative z-10 border-t border-white/5">
      <div className="container mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="overflow-hidden relative min-h-[350px] sm:min-h-[300px]">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="absolute inset-0 flex flex-col items-center justify-center text-center px-12 sm:px-16"
              >
                <Quote className="text-gold w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 opacity-30 mb-4 md:mb-6" />
                <p className="text-lg sm:text-xl md:text-3xl font-medium leading-relaxed mb-6 sm:mb-8">
